...
class Provider40 extends ProviderInterface {
    constructor() {
        ...
        this.modelName = "google/gemma-2-27b-it"
        this.modelInfo = {
            modelId: "gemma-2-27b-it",
            name: "gemma-2-27b-it",
            description: "Google's lightweight and efficient instruction-tuned language model, designed for various natural language processing tasks",
            context_window: 4096,
            author: "Google",
            unfiltered: true,
