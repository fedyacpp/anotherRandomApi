        ...
        while (retries < this.maxRetries) {
            try {
                ...
                if (completionChunks.length === 0) {
                    throw new Provider13Error('No content received from stream', "NO_CONTENT_ERROR");
                }
                ...
                if (retries < this.maxRetries) {
                    ...
                    throw new Provider13Error("Failed to generate completion after multiple attempts", "COMPLETION_GENERATION_ERROR", error);
                }
            }
        }
    }
